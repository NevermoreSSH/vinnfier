...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/add-user/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/delete-user/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/cek-user/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/renew-user/renew-ss.sh"
wget -O ssssr "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/menu/ssssr.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
