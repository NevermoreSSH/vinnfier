...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/add-user/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/delete-user/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/renew-user/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
