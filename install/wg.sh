...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/add-user/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/delete-user/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/cek-user/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/renew-user/renew-wg.sh"
wget -O wgr "https://raw.githubusercontent.com/${GitUser}/vinnfier/adata/menu/wgr.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
